...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="700" height="40" valign="top"><table width="700" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="10" colspan="17"><img src="/pags_portal/notas/imagenes/espacio.png" width="700" height="10"></td>
        </tr>
      <tr>
      ...
      <tr>
        <td rowspan="3" align="center" valign="middle" bgcolor="#D9D9D9" class="asignaturas">ASIGNATURAS</td>
        ...
        <td width="35" rowspan="3" bgcolor="#D9D9D9" class="equivalencia">&nbsp;</td>
        </tr>
      <tr>
        ...
        <td width="35" rowspan="2" bgcolor="#D9D9D9" class="subtitulos3">&nbsp;</td>
        <td height="20" colspan="3" align="center" class="porcentaje" style="font-family: Calibri; font-weight: bold; font-size: 13px;">80%</td>
        <td width="35" height="20" align="center" class="porcentaje" style="font-size: 13px; font-family: Calibri;"><span style="font-family: Calibri; font-weight: bold; font-size: 13px;">20%</span></td>
...
?>   
      <tr>
        ...
        <td bgcolor="#D9D9D9" class="promedio1" style="font-family: Candara">&nbsp;</td>
...
?>
      ...
      <tr>
        <td width="140" bgcolor="#D9D9D9" class="materias" style="font-size: 12px; font-weight: bold;">PROMEDIO QUIMESTRAL</td>
        ...
        <td colspan="5" align="center" bgcolor="#D9D9D9" class="materias" style="font-family: Calibri; font-size: 16px;">
        	<?php 
      ...
      <tr>
        <td height="10" colspan="17"><img src="/pags_portal/notas/imagenes/espacio.png" alt="" width="700" height="10" /></td>
      </tr>
      <tr>
        <td colspan="17" class="subtitulos">EVALUACI&Oacute;N DEL COMPORTAMIENTO</td>
      </tr>
      <tr>
        <td height="10" colspan="17"><img src="/pags_portal/notas/imagenes/espacio.png" width="700" height="10"></td>
        </tr>
...
?>
      ...
      <tr>
        ...
        <td bgcolor="#D9D9D9" class="nuemeros2" style="font-weight: bold; font-size: 14px; font-family: Candara;">&nbsp;</td>
        ...
        <td bgcolor="#D9D9D9" class="equivalencia" style="text-align: center; font-weight: bold; font-size: 15px;">&nbsp;</td>
...
?>
      <tr>
        ...
        <td align="center" bgcolor="#D9D9D9" class="materias" style="font-size: 16px">&nbsp;</td>
        <td colspan="5" align="center" bgcolor="#D9D9D9" class="materias" style="font-size: 16px; font-family: Calibri;"><?php echo $notas_estudiante->offsetExists('2') ? nota_to_literal($notas_estudiante[2]) : '&nbsp;'; ?><span style="text-align: center"></span></td>
        <td bgcolor="#D9D9D9" class="equivalencia2">&nbsp;</td>
      </tr>
<?php 
			}
