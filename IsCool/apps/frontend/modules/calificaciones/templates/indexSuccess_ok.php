...
?>
      ...
      <tr>
        <td class="letras">A = Excelente</td>
        <td align="center">-</td>
        <td colspan="15" class="letras">Supera los aprendizajes requeridos. <span style="font-family: Arial, Helvetica, sans-serif; font-size: 11px;">(10)</span></td>
        </tr>
      <tr>
        <td class="letras">B = Muy bueno</td>
        <td align="center">-</td>
        <td colspan="15" class="letras">Domina los aprendizajes requeridos. <span style="font-family: Arial, Helvetica, sans-serif; font-size: 11px;">(de 9.0 a 9.9)</span></td>
        </tr>
      <tr>
        <td class="letras">C = Bueno</td>
        <td align="center">-</td>
        <td colspan="15" class="letras">Alcanza los aprendizajes requeridos.<span style="font-family: Arial, Helvetica, sans-serif; font-size: 11px;"> (de7.0 a 8.9)</span></td>
        </tr>
      <tr>
        <td class="letras">D = Mejorable</td>
        <td align="center">-</td>
        <td colspan="15" class="letras">Está próximo a alcanzar los aprendizajes requeridos. <span style="font-family: Arial, Helvetica, sans-serif; font-size: 11px;">(de 4.0 a 6.9)</span></td>
        </tr>
      <tr>
        <td class="letras">E = Insatisfactorio</td>
        <td align="center">-</td>
        <td colspan="15" class="letras">No alcanza los aprendizajes requeridos. <span style="font-size: 11px; font-family: Arial, Helvetica, sans-serif;">(menor a 4.0)</span></td>
        </tr>
      <tr>
        <td height="10" colspan="17"><img src="/pags_portal/notas/imagenes/espacio.png" width="700" height="10"></td>
      </tr>
