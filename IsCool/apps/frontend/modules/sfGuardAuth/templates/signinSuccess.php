...
<?php if ($form->hasErrors()): ?>
        <div class="tipograf" id="apDiv1">
            ...
            <p><br>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
            Nombre de usuario o contrase&ntilde;a incorrectos</p>
            <p>Si tiene dificultades para ingresar al sistema, comuníquese a la secretaría de la institución<br />
            </p>
        </div>
<?php endif; ?>
  ...
  <tr>
    <td align="center"><h1 class="tipograf"><span class="titulos1" style="font-size: 20px">Ingresar al portal</span></h1>
      ...
      <form action="<?php echo url_for('@sf_guard_signin') ?>" method="post">
        <table>
          ...
          <tfoot>
            <tr>
              <td colspan="2" align="center"><input name="Boton" type="submit" class="tipograf" value="INGRESAR"></td>
            </tr>
          </tfoot>
        </table>
    </form>
