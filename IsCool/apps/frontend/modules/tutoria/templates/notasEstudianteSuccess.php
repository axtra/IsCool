...
//             $promedio_trimestral[$x] +=  $notas_estudiante->offsetExists($x) ? $notas_estudiante[$x] : 0;
//         }
?>   
      <tr>
...
?>
      <tr>
        ...
        <td colspan="4" align="center" bgcolor="#D9D9D9" class="materias" style="font-size: 16px; font-family: Calibri;"><?php echo $notas_estudiante->offsetExists('1') ? $notas_estudiante[1] : ''; ?><span style="text-align: center"></span></td>
        ...
        <td colspan="4" align="center" bgcolor="#D9D9D9" class="materias" style="font-size: 16px; font-family: Calibri;"><?php echo $notas_estudiante->offsetExists('2') ? $notas_estudiante[2] : ''; ?><span style="text-align: center"></span></td>
...
?>
      ...
      <tr>
        <td colspan="4" class="letras">E = Poco satisfactorio</td>
        <td align="center">-</td>
