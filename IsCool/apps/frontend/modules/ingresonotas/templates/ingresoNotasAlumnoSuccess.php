...
<table width="699" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="699" height="40" valign="top"><table width="700" border="0" cellspacing="0" cellpadding="0">
      <tr>
      ...
      <tr>
        ...
        <td height="20" colspan="7" class="eras1"><?php echo $estudiante->__toString() ?></td>
        <td height="20" colspan="3" class="eras1"><span class="subtitulos2">&nbsp;&nbsp; A&Ntilde;O LECTIVO:</span></td>
        <td height="20" colspan="3" class="subtitulos2">2013/2014</td>
        </tr>
      <tr>
...
?>
      ...
      <tr>
        ...
        <td bgcolor="#D9D9D9" class="equivalencia2"><?php echo(nota_to_literal($promedio_quimestral_II)); ?></td>
        <td colspan="3">&nbsp;</td>
      </tr>
      <tr>
        <td height="10" colspan="17"><img src="/pags_portal/notas/imagenes/espacio.png" alt="" width="500" height="10" /></td>
        </tr>
      <tr>
...
?>
      <tr>
        ...
        <td colspan="5" align="center" bgcolor="#D9D9D9" class="materias" style="font-size: 16px; font-family: Calibri;"><?php echo $notas_estudiante->offsetExists('1') ? $notas_estudiante[1] : '&nbsp;'; ?><span style="text-align: center"></span></td>
        <td colspan="5" align="center" bgcolor="#D9D9D9" class="materias" style="font-size: 16px; font-family: Calibri;"><?php echo $notas_estudiante->offsetExists('2') ? $notas_estudiante[2] : '&nbsp;'; ?><span style="text-align: center"></span></td>
        </tr>
<?php 
			}
        }
