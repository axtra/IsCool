...
?>
      ...
      <tr>
        ...
        <td width="38" rowspan="3" bgcolor="#FFFFFF" class="subtitulos3"><img src="/pags_portal/notas/imagenes/recuperacion.png" width="32" height="114"></td>
        <td width="38" rowspan="3" bgcolor="#FFFFFF" class="subtitulos3"><img src="/pags_portal/notas/imagenes/supletorio.png" width="32" height="114"></td>
        <td width="38" rowspan="3" bgcolor="#D9D9D9" class="subtitulos3"><img src="/pags_portal/notas/imagenes/promedio3.png" width="32" height="114"></td>
        </tr>
      <tr>
        <td height="20" colspan="3" align="center" class="porcentaje" style="font-family: Calibri; font-weight: bold; font-size: 13px;">80%</td>
        <td width="38" height="20" align="center" class="porcentaje" style="font-size: 13px; font-family: Calibri;"><span style="font-family: Calibri; font-weight: bold; font-size: 13px;">20%</span></td>
        <td width="38" rowspan="2" bgcolor="#D9D9D9" class="subtitulos3"><img src="/pags_portal/notas/imagenes/promedio.png" width="35" height="95"></td>
        <td height="20" colspan="3" align="center" class="porcentaje" style="font-family: Calibri; font-weight: bold; font-size: 13px;">80%</td>
        <td width="38" height="20" align="center" class="porcentaje" style="font-size: 13px; font-family: Calibri;"><span style="font-family: Calibri; font-weight: bold; font-size: 13px;">20%</span></td>
        <td width="38" rowspan="2" bgcolor="#D9D9D9" class="subtitulos3"><img src="/pags_portal/notas/imagenes/promedio2.png" width="35" height="95"></td>
        </tr>
      <tr>
        <td width="38" height="80" class="subtitulos3"><img src="/pags_portal/notas/imagenes/parcial1.png" width="32" height="76"></td>
        <td width="38" height="80" class="subtitulos3"><img src="/pags_portal/notas/imagenes/parcial2.png" width="32" height="76"></td>
        <td width="38" height="80" class="subtitulos3"><img src="/pags_portal/notas/imagenes/parcial3.png" width="32" height="76"></td>
        <td width="38" height="80" class="subtitulos3"><img src="/pags_portal/notas/imagenes/examen.png" width="32" height="76"></td>
        <td width="38" height="80" class="subtitulos3"><img src="/pags_portal/notas/imagenes/parcial1.png" width="32" height="76"></td>
        <td width="38" height="80" class="subtitulos3"><img src="/pags_portal/notas/imagenes/parcial2.png" width="32" height="76"></td>
        <td width="38" height="80" class="subtitulos3"><img src="/pags_portal/notas/imagenes/parcial3.png" width="32" height="76"></td>
        <td width="38" height="80" class="subtitulos3"><img src="/pags_portal/notas/imagenes/examen.png" width="32" height="76"></td>
