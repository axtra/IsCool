...
/**
 * emdiComRepresentante filter form base class.
 *
 * @package    emdi
 * @subpackage filter
 * @author     Bitcoder
 ...
 */
abstract class BaseemdiComRepresentanteFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'mre_contenido' => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'mre_estado'    => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      'mre_contenido' => new sfValidatorPass(array('required' => false)),
      'mre_estado'    => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('emdi_com_representante_filters[%s]');
