 ...
 * @property date $tar_fecha_ingreso
 ...
 * @method date                getTarFechaIngreso()   Returns the current record's "tar_fecha_ingreso" value
 ...
 * @method emdiTarea           setTarFechaIngreso()   Sets the current record's "tar_fecha_ingreso" value
...
abstract class BaseemdiTarea extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('tar_fecha_ingreso', 'date', null, array(
             'type' => 'date',
             'notnull' => true,
             ));
